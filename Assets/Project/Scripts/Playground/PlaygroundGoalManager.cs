...
/// <summary>
/// Onboarding goal to be achieved as part of the <see cref="PlaygroundGoalManager"/>.
/// </summary>
public struct PlaygroundGoal
{
    ...
    /// </summary>
    public PlaygroundGoalManager.OnboardingGoals CurrentGoal;
    ...
    /// <summary>
    /// Creates a new Goal with the specified <see cref="PlaygroundGoalManager.OnboardingGoals"/>.
    /// </summary>
    /// <param name="goal">The <see cref="GoalManager.OnboardingGoals"/> state to assign to this Goal.</param>
    public PlaygroundGoal(PlaygroundGoalManager.OnboardingGoals goal)
    {
        CurrentGoal = goal;
        Completed = false;
    }
...
/// an <see cref="PlaygroundGoalManager.OnboardingGoals"/> state to be completed by the user.
/// </summary>
public class PlaygroundGoalManager : MonoBehaviour
{
    /// <summary>
