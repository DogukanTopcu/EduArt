...
public class L5_InventorySlot : MonoBehaviour, IDropHandler
{
    public L5_DragDropManager ddm;
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        L5_DraggableItem draggableItem = dropped.GetComponent<L5_DraggableItem>();
