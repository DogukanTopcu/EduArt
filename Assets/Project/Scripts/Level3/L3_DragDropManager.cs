...
public class L3_DragDropManager : MonoBehaviour
{
    ...
    private void Start() {
        ...
        UI_D76 = FindInActiveObjectByName("UI_Developer");
        ...
        UI_Developer2 = FindInActiveObjectByName("UI_Developer2");
        ...
        relationsQueue.Add(new List<GameObject> { UI_D76.transform.GetChild(0).gameObject, UI_Beher });
    ...
    public void CompleteShake() {
        ...
        relationsQueue.Add(new List<GameObject> { UI_Tank_Beher2.transform.GetChild(0).gameObject, UI_Developer2 });
