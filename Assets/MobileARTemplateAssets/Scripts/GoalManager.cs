...
public class GoalManager : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject m_StartingPanel;
    public GameObject startingPanel
    {
        get => m_StartingPanel;
        set => m_StartingPanel = value;
    }
    ...
    [Tooltip("Object Spawner used to detect whether the spawning goal has been achieved.")]
    [SerializeField]
    Lvl1ObjSpawner m_Lvl1ObjSpawner;

    /// <summary>
    /// Object Spawner used to detect whether the spawning goal has been achieved.
    /// </summary>
    public Lvl1ObjSpawner lvl1ObjSpawner
    {
        get => m_Lvl1ObjSpawner;
        set => m_Lvl1ObjSpawner = value;
    }
    ...
    void CompleteGoal()
    {
        if (m_CurrentGoal.CurrentGoal == OnboardingGoals.TapSurface)
            m_Lvl1ObjSpawner.objectSpawned -= OnObjectSpawned;
    ...
    void PreprocessGoal()
    {
        ...
        {
            m_StartingPanel.SetActive(true);
